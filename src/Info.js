...
const PlanYourTripBody = (
    ...
    "This web app was my first time dipping into the software development world, learning for the first time how back end and front end work together." + 
    ...
    "There was one really big downside to this project however, and that was no custom CSS was allowed, only the CSS provided could be used. This limited " + 
    ...
    "with a framework such as React.\n\n"  + 
    "After the application was completed, I wanted to learn how to host it on my own servers. This is when I learned about the EC2 VM that AWS runs. I had to learn " + 
...
const COVIDBody = (
    ...
    "The COVID data seemed perfect for this considering it's constantly changing and I could finally learn how to graph the data in react. After getting very familiar " + 
    "with react-bootstrap I realized it was time to learn a more complex react framework, Material-UI." + 
    ...
    "the country and see the total in a nice bar graph."
)
